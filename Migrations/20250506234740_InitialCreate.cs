    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 101, "Community Development", new DateTime(2025, 5, 6, 19, 47, 39, 99, DateTimeKind.Local).AddTicks(8455), "Brings smiles and solar-powered radios to remote villages one playlist at a time.", "DWBtest.gmail.com", "https://images.openai.com/thumbnails/39a8828844b53eb51453e3cd9e306ec8.png", "Cultivating hope and sustainable futures through global community development, education, and agricultural empowerment.", "HopeHarvest International", "XdynYdPxtmTU4VghjX2paBdQC9b2", "HarvestInter@test.com" },
                    { 102, "Education", new DateTime(2025, 5, 6, 19, 47, 39, 99, DateTimeKind.Local).AddTicks(8762), "Delivers enchanted storybooks to children in magical lands (and a few underfunded libraries).", "BFBtest.gmail.com", "https://m.media-amazon.com/images/I/81ukSP5PrJL._AC_UF1000%2C1000_QL80_.jpg", "Expanding minds and opportunities by delivering books and educational resources to underserved communities around the world.", "Books for Beyond", "XdynYdPxtmTU4VghjX2paBdQC9b2", "Beyond@test.com" },
                    { 103, "Humanitarian Aid", new DateTime(2025, 5, 6, 19, 47, 39, 99, DateTimeKind.Local).AddTicks(8769), "Knits invisible scarves for people experiencing metaphorical winters.", "WOWtest.gmail.com", "https://www.shutterstock.com/image-photo/flock-white-pelicans-soars-gracefully-over-2603037941", "To deliver warmth, comfort, and hope to vulnerable individuals through seasonal support programs, emergency aid, and community-driven outreach initiatives.", "Wings of Warmth", "XdynYdPxtmTU4VghjX2paBdQC9b2", "WarmWing@test.com" },
                    { 104, "Environment", new DateTime(2025, 5, 6, 19, 47, 39, 99, DateTimeKind.Local).AddTicks(8774), "Sends love letters and biodegradable glitter to lonely sea creatures.", "OHPtest.gmail.com", "https://i0.wp.com/oceanblueproject.org/wp-content/uploads/2023/05/happy-world-ocean-day-activities-ocean-blue-project-cleanup.webp?fit=2048%2C1367&ssl=1", "To protect and nurture our oceans through grassroots conservation efforts, education, and community engagement, inspiring a global embrace of marine stewardship.", "Ocean Hug Project", "XdynYdPxtmTU4VghjX2paBdQC9b2", "OHP@test.com" },
                    { 105, "Animal Welfare", new DateTime(2025, 5, 6, 19, 47, 39, 99, DateTimeKind.Local).AddTicks(8779), "Helps vertically challenged animals reach their dreams (and the top shelf).", "TGLFtest.gmail.com", "https://media.istockphoto.com/id/543346734/photo/giraffe-in-the-library.jpg?s=2048x2048&w=is&k=20&c=PgjqCSR3ad0uzcPHpnR9ji6oAmuTJFAHhp0JDL8rpas=", "To elevate opportunities for conservation, education, and leadership through projects that help communities—and endangered giraffes—rise to new heights.", "The Giraffe Ladder Fund", "XdynYdPxtmTU4VghjX2paBdQC9b2", "GLF@test.com" },
                    { 106, "Humanitarian Aid", new DateTime(2025, 5, 6, 19, 47, 39, 99, DateTimeKind.Local).AddTicks(8789), "Helps friendless goobers get all the companions they need.", "goobers@example.com", "https://i1.sndcdn.com/avatars-000127116014-hqzcna-t240x240.jpg", "Bring all goobers together", "Visiting Goobers", "9wNJQC9hfrMhjpdOUPD1wxjqLjE2", "Goob@test.com" },
                    { 107, "Humanitarian Aid", new DateTime(2025, 5, 6, 19, 47, 39, 99, DateTimeKind.Local).AddTicks(8794), "Red shorts initiative, everyone deserves a pair. Polka dots are also allowed.", "theRedShorts@example.com", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQAyHT6BTbA-AKsM_-FIwE382ec-uIYKOE-Vg&s", "Shorts for days", "American Red Shorts", "9wNJQC9hfrMhjpdOUPD1wxjqLjE2", "shorts@test.com" },
                    { 108, "Humanitarian Aid", new DateTime(2025, 5, 6, 19, 47, 39, 99, DateTimeKind.Local).AddTicks(8868), "Help the salvation army by adding to my bank account.", "johnelmo@example.com", "https://st2.depositphotos.com/3758943/6040/i/450/depositphotos_60400957-stock-photo-the-man-in-the-office.jpg", "We shall support the cause", "The Salvation Army’s biggest supporter", "9wNJQC9hfrMhjpdOUPD1wxjqLjE2", "Broc@test.com" },
                    { 109, "Education", new DateTime(2025, 5, 6, 19, 47, 39, 99, DateTimeKind.Local).AddTicks(8872), "One of the orgs yeah yeah", "brocbuhler@gmail.com", "https://i.ytimg.com/vi/k9KAc23W48s/sddefault.jpg", "Brocs Retirment", "Broc's Bank Account", "9wNJQC9hfrMhjpdOUPD1wxjqLjE2", "Broc@test.com" },
                    { 110, "Animal Welfare", new DateTime(2025, 5, 6, 19, 47, 39, 99, DateTimeKind.Local).AddTicks(8879), "Give me money for cat NOW.", "givecat@gmail.com", "https://media.npr.org/assets/img/2023/12/12/gettyimages-1054147940-627235e01fb63b4644bec84204c259f0a343e35b.jpg", "Rescue all felines", "Cat", "9wNJQC9hfrMhjpdOUPD1wxjqLjE2", "cat@test.com" },
                    { 111, "Environment", new DateTime(2025, 5, 6, 19, 47, 39, 99, DateTimeKind.Local).AddTicks(8883), "We are like super dark and edgy bro look at our spiky ghost king crowns and our exploding orc birth sacs.", "cuteSaronPIcs@mordor.com", "https://i.redd.it/the-two-towers-vs-return-of-the-king-mordor-v0-b352b0r01tyb1.jpg?width=3816&format=pjpg&auto=webp&s=c3f5494c21e1ccfc774b3bb8649fcfc8a2670ea3", "Bring about the rise of mordor", "The Dark Organization", "9wNJQC9hfrMhjpdOUPD1wxjqLjE2", "mordor@test.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 108, "Monthly", 10.00m, "paypal", new DateTime(2025, 5, 6, 19, 47, 39, 95, DateTimeKind.Local).AddTicks(4022), "9wNJQC9hfrMhjpdOUPD1wxjqLjE2" },
                    { 2, 102, "Quarterly", 10.00m, "debit", new DateTime(2025, 5, 6, 19, 47, 39, 98, DateTimeKind.Local).AddTicks(7181), "9wNJQC9hfrMhjpdOUPD1wxjqLjE2" },
                    { 3, 106, "Monthly", 10.00m, "mastercard", new DateTime(2025, 5, 6, 19, 47, 39, 98, DateTimeKind.Local).AddTicks(7265), "9wNJQC9hfrMhjpdOUPD1wxjqLjE2" },
                    { 4, 104, "Weekly", 10.00m, "cryptocurrency", new DateTime(2025, 5, 6, 19, 47, 39, 98, DateTimeKind.Local).AddTicks(7279), "XdynYdPxtmTU4VghjX2paBdQC9b2" },
                    { 5, 105, "Yearly", 10.00m, "visa", new DateTime(2025, 5, 6, 19, 47, 39, 98, DateTimeKind.Local).AddTicks(7285), "XdynYdPxtmTU4VghjX2paBdQC9b2" }
                });
